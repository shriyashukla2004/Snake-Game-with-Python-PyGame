...
class Game:
    ...
    def on_init(self):
        ...
        self._snake_image= pygame.image.load("C:/Users/KIIT/Downloads/snake.png").convert()
        self._apple_image= pygame.image.load("C:/Users/KIIT/Downloads/apple.png").convert()
    ...
    def on_render(self):
        self._display_surf.fill((0,0,0)) #black screen
